...
public class OrderController {
	...
	@RequestMapping("checkout/vnpay/choose_banking")
	public String VNPAY() {
		return "order/status_banking";
	}
	
	@RequestMapping("/banking")
	public String VNPAY_banking() {
		return "https://sandbox.vnpayment.vn/tryitnow/Home/CreateOrder";
	}
}
